...
└────────⬣`.trim(),
          "footerText": "┌─〔 Catatan 〕─⬣\n│⬡ Silahkan Tekan Tombol \" Click Here \" Untuk Melihat\n│⬡ Sub-Menu Bot.\n│⬡ Jika Menemukan Bug, Error Atau Kesulitan\n│⬡ Dalam Penggunaan Silahkan Laporkan/\n│⬡ Tanyakan Kepada Owner.\n└────────⬣\n © bagus ganz",
          "buttonText": "Click Here",
          "listType": "SINGLE_SELECT",
          "sections": [
            {
            "title": `Runtime bot ${uptime} - ©bagus ganz`,
              "rows": [
                {
                  "title": "『🤖』owner astro bot",
                  "description": "pemilik bot",
                  "rowId": ".owner"
                }, {
                  "title": "『❗』script astro bot",
                  "description": "memberikan script astro bot",
                  "rowId": ".sc"
                }, {
                  "title": `『❤️』Semua Perintah`,
    ...
    await conn.send3ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), footer, 'Owner Bot', '.owner', 'group bot', 'gcbot', 'sc astro bot', '.sc', m)
